...
def problem2_3(ne):
    for items in ne:
        print(items,"has",len(items),"letters.")
...
def problem2_7():
    ...
    sideA = float(input("Enter the length of side one: "))
    sideB = float(input("Enter the length of side two: "))
    sideC = float(input("Enter the length of side three: "))
